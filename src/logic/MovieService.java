...
public class MovieService extends MovieServiceBase {
	...
	public MovieService() {
		...
		MongoClient mongoClient = MongoClients.create("mongodb://root:password@localhost");
		// TODO Select database "imdb"
		MongoDatabase db = mongoClient.getDatabase("imdb");
...
// ...
	 ...
	 */
	public void createMovieData(MongoCollection movies, MongoCollection tweets) {
		clearDatabase(movies, tweets);
	 ...
	 */
	public void clearDatabase(MongoCollection movies, MongoCollection tweets) {
	 ...
	 */
	public void printCollections(MongoDatabase db) {
